...
function Product2(name, price, count){
    this.name = name;
    this.price = price;
    this.count = count;
}

let product1 = new Product('신발', 120000, 3).toJSON;
let product2 = new Product('모자', 50000, 7).toJSON;
let product3 = new Product('가방', 250000, 10).toJSON;
let product4 = new Product2('가방', 250000, 10);
let product5 = new Product2('가방', 250000, 10);
let product6 = new Product2('가방', 250000, 10);

let products = new Array(product1, product2 ,product3);
let products2 = new Array(product4, product5 ,product6);

console.log(products)
console.log(products2)
let productsJSON = JSON.stringify(products2);
